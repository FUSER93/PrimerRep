   ...
   public function validarDatos($datos, $repo){
     if (!isset($datos['terminos'])) {
      ...
      if (trim($datos['apellido']) == ''){
       ...
       }elseif (!preg_match("/^(?!-+)[a-zA-Z-ñáéíóú\s]*$/", $datos['profesion'])){
         $errores['profesion'] = "¡La profesion tiene un formato incorrecto!";
       }
       ...
       if ($datos['ciudad'] == 'Seleccione una Ciudad'){
         ...
         if (!($extension == 'jpg' || $extension == 'jpeg' || $extension == 'png')){
           $errores['avatar'] = 'El formato tiene que ser JPG, JPEG o PNG';
          }
         }
         return $errores;
        }
